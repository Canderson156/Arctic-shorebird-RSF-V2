...
test <- raster(file_list[1])
test2 <- raster(file_list[2])
test3 <- mosaic_rasters(file_list[1], file_list[2])

mosaic_rasters(file_list, "data/landcover/Northern_Land_Cover_2000/landcover_mosaic.tif")
